...
|------------------------|------|---------|-------|-------|-----|---------|----|----|
| [Clash for Android](https://clashforandroid.org/)      | :red_circle:    | :x:       | :x:     | :x:     | :x:   | :white_check_mark:       | [备份](https://github.com/clash-latest/Clash-for-Android) | [教程](https://clashforandroid.org/) |
| [Clash for Windows](https://clashforwindows.org/)      | :red_circle:    | :white_check_mark:       | :white_check_mark:     | :white_check_mark:     | :x:   | :x:       | [备份](https://github.com/clash-latest/Clash-for-Windows) | [教程](https://clashforwindows.org/) |
...
| [ClashX](https://clashx.org/)                 | :red_circle:    | :x:       | :white_check_mark:     | :x:     | :x:   | :x:       | [备份](https://github.com/clash-latest/ClashX) | [教程](https://clashx.org/) |
...
- **下载地址**：[GitHub备份](https://github.com/clash-latest/Clash-for-Windows)
- **使用教程**：[https://clashforwindows.org/](https://clashforwindows.org/)
- **支持平台**：Windows、macOS、Linux

### :pushpin: ClashX
- **下载地址**：[GitHub备份](https://github.com/clash-latest/ClashX)
- **使用教程**：[https://clashx.org/](https://clashx.org/)
- **支持平台**：macOS

### :pushpin: Clash for Android
- **下载地址**：[GitHub备份](https://github.com/clash-latest/Clash-for-Android)
